; Inno Setup Script for Hand History De-anonymizer
...
OutputBaseFilename=HandHistoryDeanonymizer_Setup_{#MyAppVersion}
Compression=lzma
...
Source: "dist\Hand History De-anonymizer\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
